...
const General = () => {
  ...
  return (
    <section>
      ...
      <div className="flex items-center justify-between border-b border-blue-200 font-medium mb-4">
        <p className="font-semibold">Email</p>
        <p>{email}</p>
      </div>
      <div className="flex items-center justify-between border-b border-blue-400 font-medium mb-4">
