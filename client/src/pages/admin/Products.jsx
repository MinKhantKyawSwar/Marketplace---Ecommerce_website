...
const Products = ({ products, getProducts, totalPages, currentPage }) => {
  ...
  return (
    <section>
      ...
      <div className="flex mt-5 mb-20 justify-end max-w-6xl mx-auto">
        <Pagination current={currentPage} total={totalPages * 6} onChange={handlePagination}/>
      </div>
    </section>
  );
};
